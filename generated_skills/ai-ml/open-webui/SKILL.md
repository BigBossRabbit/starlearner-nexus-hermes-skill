...
hermes skills install open-webui --tap BigBossRabbit/starlearner-nexus-hermes-skill
...
- Provides: User-friendly AI Interface (Supports Ollama, OpenAI API, ...)
...
hermes skills install open-webui --tap { github_username }/starlearner-nexus-hermes-skill
...
- This skill provides convenient access to the open-webui repository within your Hermes agent ecosystem
- For advanced usage, consult the original repository documentation at: https://github.com/open-webui/open-webui
...
- https://github.com/open-webui/open-webui/#readme for setup instructions
- https://github.com/open-webui/open-webui/wiki for detailed documentation
- https://github.com/open-webui/open-webui/examples for usage examples



## 🔧 Installation

The open-webui skill provides access to the repository within your Hermes agent.
...
- Skill generated from: https://github.com/open-webui/open-webui
...
To manually update: `hermes skills update open-webui --tap BigBossRabbit/starlearner-nexus-hermes-skill`
