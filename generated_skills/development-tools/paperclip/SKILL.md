...
hermes skills install paperclip --tap BigBossRabbit/starlearner-nexus-hermes-skill
...
- Integrates with paperclip (https://github.com/paperclipai/paperclip)

- Provides: The open-source app everyone uses to manage agents at work
...
hermes skills install paperclip --tap { github_username }/starlearner-nexus-hermes-skill
...
- This skill provides convenient access to the paperclip repository within your Hermes agent ecosystem
- For advanced usage, consult the original repository documentation at: https://github.com/paperclipai/paperclip
...
- https://github.com/paperclipai/paperclip/#readme for setup instructions
- https://github.com/paperclipai/paperclip/wiki for detailed documentation
- https://github.com/paperclipai/paperclip/examples for usage examples



## 🔧 Installation

The paperclip skill provides access to the repository within your Hermes agent.
...
- Skill generated from: https://github.com/paperclipai/paperclip
...
To manually update: `hermes skills update paperclip --tap BigBossRabbit/starlearner-nexus-hermes-skill`
