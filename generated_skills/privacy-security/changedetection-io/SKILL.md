...
hermes skills install changedetection-io --tap BigBossRabbit/starlearner-nexus-hermes-skill
...
- Integrates with changedetection.io (https://github.com/dgtlmoon/changedetection.io)

- Provides: Best and simplest tool for website change detection, web page monitoring, and website change alerts. Perfect for tracking content changes, price drops, restock alerts, and website defacement monito...
...
hermes skills install changedetection-io --tap { github_username }/starlearner-nexus-hermes-skill
...
- This skill provides convenient access to the changedetection.io repository within your Hermes agent ecosystem
- For advanced usage, consult the original repository documentation at: https://github.com/dgtlmoon/changedetection.io
...
- https://github.com/dgtlmoon/changedetection.io/#readme for setup instructions
- https://github.com/dgtlmoon/changedetection.io/wiki for detailed documentation
- https://github.com/dgtlmoon/changedetection.io/examples for usage examples



## 🔧 Installation

The changedetection.io skill provides access to the repository within your Hermes agent.
...
- Skill generated from: https://github.com/dgtlmoon/changedetection.io
...
To manually update: `hermes skills update changedetection-io --tap BigBossRabbit/starlearner-nexus-hermes-skill`
