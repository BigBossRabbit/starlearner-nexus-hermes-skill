...
hermes skills install open-codex --tap BigBossRabbit/starlearner-nexus-hermes-skill
...
- Integrates with open-codex (https://github.com/ymichael/open-codex)

- Provides: Lightweight coding agent that runs in your terminal

- Implemented in TypeScript

- Available as npm/yarn package

- Well-known project with 2,205 GitHub stars

- Actively developed with 187 forks

- Licensed under Apache License 2.0

- Substantial codebase (19799 KB)

- Monitored by 2,205 GitHub users
...
hermes skills install open-codex --tap { github_username }/starlearner-nexus-hermes-skill
...
git clone https://github.com/ymichael/open-codex
cd open-codex
npm install
...
- This skill provides convenient access to the open-codex repository within your Hermes agent ecosystem
- For advanced usage, consult the original repository documentation at: https://github.com/ymichael/open-codex
...
- https://github.com/ymichael/open-codex/#readme for setup instructions
- https://github.com/ymichael/open-codex/wiki for detailed documentation
- https://github.com/ymichael/open-codex/examples for usage examples



## 🔧 Installation

The open-codex skill provides access to the repository within your Hermes agent.
...
- Skill generated from: https://github.com/ymichael/open-codex
...
This skill was automatically generated from the GitHub repository: https://github.com/ymichael/open-codex
Generated on: 2026-05-15 21:21:46
Original repository: 
Project homepage: https://www.npmjs.com/package/open-codex
...
To manually update: `hermes skills update open-codex --tap BigBossRabbit/starlearner-nexus-hermes-skill`
