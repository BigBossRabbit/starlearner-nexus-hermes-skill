...
hermes skills install rocket-chat --tap BigBossRabbit/starlearner-nexus-hermes-skill
...
- Integrates with Rocket.Chat (https://github.com/RocketChat/Rocket.Chat)

- Provides: The Secure CommsOS™ for mission-critical operations
...
hermes skills install rocket-chat --tap { github_username }/starlearner-nexus-hermes-skill
...
- This skill provides convenient access to the Rocket.Chat repository within your Hermes agent ecosystem
- For advanced usage, consult the original repository documentation at: https://github.com/RocketChat/Rocket.Chat
...
- https://github.com/RocketChat/Rocket.Chat/#readme for setup instructions
- https://github.com/RocketChat/Rocket.Chat/wiki for detailed documentation
- https://github.com/RocketChat/Rocket.Chat/examples for usage examples



## 🔧 Installation

The Rocket.Chat skill provides access to the repository within your Hermes agent.
...
- Skill generated from: https://github.com/RocketChat/Rocket.Chat
...
To manually update: `hermes skills update rocket-chat --tap BigBossRabbit/starlearner-nexus-hermes-skill`
