...
hermes skills install bluewallet --tap BigBossRabbit/starlearner-nexus-hermes-skill
...
- Integrates with BlueWallet (https://github.com/BlueWallet/BlueWallet)

- Provides: Bitcoin wallet for iOS & Android. Built with React Native

- Implemented in TypeScript

- Available as npm/yarn package

- Well-known project with 3,203 GitHub stars

- Widely forked with 1,021 forks indicating community engagement

- Related to: bitcoin, bitcoinjs, blockchain, cryptocurrency, react-native
...
hermes skills install bluewallet --tap { github_username }/starlearner-nexus-hermes-skill
...
- This skill provides convenient access to the BlueWallet repository within your Hermes agent ecosystem
- For advanced usage, consult the original repository documentation at: https://github.com/BlueWallet/BlueWallet
...
- https://github.com/BlueWallet/BlueWallet/#readme for setup instructions
- https://github.com/BlueWallet/BlueWallet/wiki for detailed documentation
- https://github.com/BlueWallet/BlueWallet/examples for usage examples



## 🔧 Installation

The BlueWallet skill provides access to the repository within your Hermes agent.
...
- Skill generated from: https://github.com/BlueWallet/BlueWallet
...
To manually update: `hermes skills update bluewallet --tap BigBossRabbit/starlearner-nexus-hermes-skill`
