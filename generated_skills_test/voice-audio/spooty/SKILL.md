...
hermes skills install spooty --tap BigBossRabbit/starlearner-nexus-hermes-skill
...
- Integrates with spooty (https://github.com/Raiper34/spooty)

- Provides: Self-hosted  spotify downloader
...
- Related to: downloader, music, self-hosted, spotify
...
hermes skills install spooty --tap { github_username }/starlearner-nexus-hermes-skill
...
git clone https://github.com/Raiper34/spooty
cd spooty
npm install
...
- This skill provides convenient access to the spooty repository within your Hermes agent ecosystem
- For advanced usage, consult the original repository documentation at: https://github.com/Raiper34/spooty
...
- https://github.com/Raiper34/spooty/#readme for setup instructions
- https://github.com/Raiper34/spooty/wiki for detailed documentation
- https://github.com/Raiper34/spooty/examples for usage examples



## 🔧 Installation

The spooty skill provides access to the repository within your Hermes agent.
...
- Skill generated from: https://github.com/Raiper34/spooty
...
To manually update: `hermes skills update spooty --tap BigBossRabbit/starlearner-nexus-hermes-skill`
