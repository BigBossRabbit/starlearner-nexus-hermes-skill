...
hermes skills install trek --tap BigBossRabbit/starlearner-nexus-hermes-skill
...
- Integrates with TREK (https://github.com/mauriceboe/TREK)

- Provides: A self-hosted travel/trip planner with real-time collaboration, interactive maps, PWA support, SSO, budgets, packing lists, and more.
...
- Related to: budget-tracker, collaborative, open-source, opensource, packing-list
...
hermes skills install trek --tap { github_username }/starlearner-nexus-hermes-skill
...
- This skill provides convenient access to the TREK repository within your Hermes agent ecosystem
- For advanced usage, consult the original repository documentation at: https://github.com/mauriceboe/TREK
...
- https://github.com/mauriceboe/TREK/#readme for setup instructions
- https://github.com/mauriceboe/TREK/wiki for detailed documentation
- https://github.com/mauriceboe/TREK/examples for usage examples



## 🔧 Installation

The TREK skill provides access to the repository within your Hermes agent.
...
- Skill generated from: https://github.com/mauriceboe/TREK
...
To manually update: `hermes skills update trek --tap BigBossRabbit/starlearner-nexus-hermes-skill`
