...
hermes skills install fonoster --tap BigBossRabbit/starlearner-nexus-hermes-skill
...
- Integrates with fonoster (https://github.com/fonoster/fonoster)

- Provides: 🚀 The open-source alternative to Twilio.

- Implemented in TypeScript

- Available as npm/yarn package

- Well-known project with 7,924 GitHub stars

- Actively developed with 515 forks

- Related to: cloud, cloud-communications-platform, cpaas, customer-engagement, customer-experience

- Licensed under MIT License

- Large codebase (231318 KB)

- Monitored by 7,924 GitHub users
...
hermes skills install fonoster --tap { github_username }/starlearner-nexus-hermes-skill
...
- This skill provides convenient access to the fonoster repository within your Hermes agent ecosystem
- For advanced usage, consult the original repository documentation at: https://github.com/fonoster/fonoster
...
- https://github.com/fonoster/fonoster/#readme for setup instructions
- https://github.com/fonoster/fonoster/wiki for detailed documentation
- https://github.com/fonoster/fonoster/examples for usage examples



## 🔧 Installation

The fonoster skill provides access to the repository within your Hermes agent.
...
- Skill generated from: https://github.com/fonoster/fonoster
...
This skill was automatically generated from the GitHub repository: https://github.com/fonoster/fonoster
Generated on: 2026-05-15 20:47:24
Original repository: 
Project homepage: https://fonoster.com
...
To manually update: `hermes skills update fonoster --tap BigBossRabbit/starlearner-nexus-hermes-skill`
