...
hermes skills install ruflo --tap BigBossRabbit/starlearner-nexus-hermes-skill
...
- Integrates with ruflo (https://github.com/ruvnet/ruflo)

- Provides: 🌊 The leading agent orchestration platform for Claude. Deploy intelligent multi-agent swarms, coordinate autonomous workflows, and build conversational AI systems. Features    enterprise-grade arch...
...
hermes skills install ruflo --tap { github_username }/starlearner-nexus-hermes-skill
...
- This skill provides convenient access to the ruflo repository within your Hermes agent ecosystem
- For advanced usage, consult the original repository documentation at: https://github.com/ruvnet/ruflo
...
- https://github.com/ruvnet/ruflo/#readme for setup instructions
- https://github.com/ruvnet/ruflo/wiki for detailed documentation
- https://github.com/ruvnet/ruflo/examples for usage examples



## 🔧 Installation

The ruflo skill provides access to the repository within your Hermes agent.
...
- Skill generated from: https://github.com/ruvnet/ruflo
...
To manually update: `hermes skills update ruflo --tap BigBossRabbit/starlearner-nexus-hermes-skill`
