...
hermes skills install openusage --tap BigBossRabbit/starlearner-nexus-hermes-skill
...
- Integrates with openusage (https://github.com/robinebers/openusage)

- Provides: Burning through your subscriptions too fast? Paying for stuff you never use? Stop guessing. OpenUsage is free and open source.

- Implemented in JavaScript

- Available as npm/yarn package

- Well-known project with 2,444 GitHub stars

- Actively developed with 220 forks

- Related to: claude, codex, copilot, cursor, subscription

- Licensed under MIT License

- Substantial codebase (35868 KB)

- Monitored by 2,444 GitHub users
...
hermes skills install openusage --tap { github_username }/starlearner-nexus-hermes-skill

# Run the skill
hermes skills run openusage
```

## JavaScript-Specific Usage
...
- This skill provides convenient access to the openusage repository within your Hermes agent ecosystem
- For advanced usage, consult the original repository documentation at: https://github.com/robinebers/openusage
...
- https://github.com/robinebers/openusage/#readme for setup instructions
- https://github.com/robinebers/openusage/wiki for detailed documentation
- https://github.com/robinebers/openusage/examples for usage examples



## 🔧 Installation

The openusage skill provides access to the repository within your Hermes agent.

## Language Runtime

This skill is for a JavaScript repository. Depending on how you plan to use it, you may need to install:
- Node.js runtime
...
- Skill generated from: https://github.com/robinebers/openusage
...
This skill was automatically generated from the GitHub repository: https://github.com/robinebers/openusage
Generated on: 2026-05-15 20:47:24
Original repository: 
Project homepage: https://www.openusage.ai
...
This skill provides access to a JavaScript repository. Actual dependencies depend on how you use the underlying repository:
...
To manually update: `hermes skills update openusage --tap BigBossRabbit/starlearner-nexus-hermes-skill`
