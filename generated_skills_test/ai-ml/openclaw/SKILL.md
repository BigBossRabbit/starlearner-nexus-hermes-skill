...
hermes skills install openclaw --tap BigBossRabbit/starlearner-nexus-hermes-skill
...
- Integrates with openclaw (https://github.com/openclaw/openclaw)

- Provides: Your own personal AI assistant. Any OS. Any Platform. The lobster way. 🦞
...
hermes skills install openclaw --tap { github_username }/starlearner-nexus-hermes-skill
...
- This skill provides convenient access to the openclaw repository within your Hermes agent ecosystem
- For advanced usage, consult the original repository documentation at: https://github.com/openclaw/openclaw
...
- https://github.com/openclaw/openclaw/#readme for setup instructions
- https://github.com/openclaw/openclaw/wiki for detailed documentation
- https://github.com/openclaw/openclaw/examples for usage examples



## 🔧 Installation

The openclaw skill provides access to the repository within your Hermes agent.
...
- Skill generated from: https://github.com/openclaw/openclaw
...
Generated on: 2026-05-15 20:47:23
Original repository: 
...
To manually update: `hermes skills update openclaw --tap BigBossRabbit/starlearner-nexus-hermes-skill`
