...
hermes skills install editor --tap BigBossRabbit/starlearner-nexus-hermes-skill
...
- Integrates with editor (https://github.com/pascalorg/editor)

- Provides: Create and share 3D architectural projects.
...
hermes skills install editor --tap { github_username }/starlearner-nexus-hermes-skill
...
- This skill provides convenient access to the editor repository within your Hermes agent ecosystem
- For advanced usage, consult the original repository documentation at: https://github.com/pascalorg/editor
...
- https://github.com/pascalorg/editor/#readme for setup instructions
- https://github.com/pascalorg/editor/wiki for detailed documentation
- https://github.com/pascalorg/editor/examples for usage examples



## 🔧 Installation

The editor skill provides access to the repository within your Hermes agent.
...
- Skill generated from: https://github.com/pascalorg/editor
...
To manually update: `hermes skills update editor --tap BigBossRabbit/starlearner-nexus-hermes-skill`
