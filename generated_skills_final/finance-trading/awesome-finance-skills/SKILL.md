...
hermes skills install awesome-finance-skills --tap BigBossRabbit/starlearner-nexus-hermes-skill
...
- Integrates with Awesome-finance-skills (https://github.com/RKiding/Awesome-finance-skills)

- Provides: A collection of Awesome Finance Agent Skills for free and easy to start | 一系列开源免费的金融分析Agent Skills
...
hermes skills install awesome-finance-skills --tap { github_username }/starlearner-nexus-hermes-skill
...
- This skill provides convenient access to the Awesome-finance-skills repository within your Hermes agent ecosystem
- For advanced usage, consult the original repository documentation at: https://github.com/RKiding/Awesome-finance-skills
...
- https://github.com/RKiding/Awesome-finance-skills/#readme for setup instructions
- https://github.com/RKiding/Awesome-finance-skills/wiki for detailed documentation
- https://github.com/RKiding/Awesome-finance-skills/examples for usage examples



## 🔧 Installation

The Awesome-finance-skills skill provides access to the repository within your Hermes agent.
...
- Skill generated from: https://github.com/RKiding/Awesome-finance-skills
...
To manually update: `hermes skills update awesome-finance-skills --tap BigBossRabbit/starlearner-nexus-hermes-skill`
