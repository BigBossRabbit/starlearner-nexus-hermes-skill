...
hermes skills install tradingagents --tap BigBossRabbit/starlearner-nexus-hermes-skill
...
- Integrates with TradingAgents (https://github.com/TauricResearch/TradingAgents)

- Provides: TradingAgents: Multi-Agents LLM Financial Trading Framework
...
- Related to: agent, finance, llm, multiagent, trading
...
hermes skills install tradingagents --tap { github_username }/starlearner-nexus-hermes-skill
...
- This skill provides convenient access to the TradingAgents repository within your Hermes agent ecosystem
- For advanced usage, consult the original repository documentation at: https://github.com/TauricResearch/TradingAgents
...
- https://github.com/TauricResearch/TradingAgents/#readme for setup instructions
- https://github.com/TauricResearch/TradingAgents/wiki for detailed documentation
- https://github.com/TauricResearch/TradingAgents/examples for usage examples



## 🔧 Installation

The TradingAgents skill provides access to the repository within your Hermes agent.
...
- Skill generated from: https://github.com/TauricResearch/TradingAgents
...
To manually update: `hermes skills update tradingagents --tap BigBossRabbit/starlearner-nexus-hermes-skill`
