...
hermes skills install get-shit-done --tap BigBossRabbit/starlearner-nexus-hermes-skill
...
- Integrates with get-shit-done (https://github.com/gsd-build/get-shit-done)

- Provides: A light-weight and powerful meta-prompting, context engineering and spec-driven development system for Claude Code by TÂCHES.
...
hermes skills install get-shit-done --tap { github_username }/starlearner-nexus-hermes-skill
...
- This skill provides convenient access to the get-shit-done repository within your Hermes agent ecosystem
- For advanced usage, consult the original repository documentation at: https://github.com/gsd-build/get-shit-done
...
- https://github.com/gsd-build/get-shit-done/#readme for setup instructions
- https://github.com/gsd-build/get-shit-done/wiki for detailed documentation
- https://github.com/gsd-build/get-shit-done/examples for usage examples



## 🔧 Installation

The get-shit-done skill provides access to the repository within your Hermes agent.
...
- Skill generated from: https://github.com/gsd-build/get-shit-done
...
To manually update: `hermes skills update get-shit-done --tap BigBossRabbit/starlearner-nexus-hermes-skill`
