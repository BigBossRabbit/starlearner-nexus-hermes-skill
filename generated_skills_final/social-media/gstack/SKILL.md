...
hermes skills install gstack --tap BigBossRabbit/starlearner-nexus-hermes-skill
...
- Integrates with gstack (https://github.com/garrytan/gstack)

- Provides: Use Garry Tan's exact Claude Code setup: 23 opinionated tools that serve as CEO, Designer, Eng Manager, Release Manager, Doc Engineer, and QA
...
hermes skills install gstack --tap { github_username }/starlearner-nexus-hermes-skill
...
- This skill provides convenient access to the gstack repository within your Hermes agent ecosystem
- For advanced usage, consult the original repository documentation at: https://github.com/garrytan/gstack
...
- https://github.com/garrytan/gstack/#readme for setup instructions
- https://github.com/garrytan/gstack/wiki for detailed documentation
- https://github.com/garrytan/gstack/examples for usage examples



## 🔧 Installation

The gstack skill provides access to the repository within your Hermes agent.
...
- Skill generated from: https://github.com/garrytan/gstack
...
To manually update: `hermes skills update gstack --tap BigBossRabbit/starlearner-nexus-hermes-skill`
