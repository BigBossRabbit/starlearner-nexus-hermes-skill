...
hermes skills install deep-live-cam --tap BigBossRabbit/starlearner-nexus-hermes-skill
...
- Integrates with Deep-Live-Cam (https://github.com/hacksider/Deep-Live-Cam)

- Provides: real time face swap and one-click video deepfake with only a single image
...
hermes skills install deep-live-cam --tap { github_username }/starlearner-nexus-hermes-skill
...
- This skill provides convenient access to the Deep-Live-Cam repository within your Hermes agent ecosystem
- For advanced usage, consult the original repository documentation at: https://github.com/hacksider/Deep-Live-Cam
...
- https://github.com/hacksider/Deep-Live-Cam/#readme for setup instructions
- https://github.com/hacksider/Deep-Live-Cam/wiki for detailed documentation
- https://github.com/hacksider/Deep-Live-Cam/examples for usage examples



## 🔧 Installation

The Deep-Live-Cam skill provides access to the repository within your Hermes agent.
...
- Skill generated from: https://github.com/hacksider/Deep-Live-Cam
...
To manually update: `hermes skills update deep-live-cam --tap BigBossRabbit/starlearner-nexus-hermes-skill`
